auction_items = [[6926, "Mono Lisa", 1030312, 0], [1828, "girl with pearl earring", 5012300, 0], [9598, "the starry night", 7480120, 0],
                 [1553, "saint john the baptist", 6038467, 0], [4808, "The last supper", 723404, 0],
                 [4799, "La Vierge aux rochers", 2384782, 0], [9657, "The Vitruvian Man", 2783480, 0],
                 [8877, "leanardo davinci self portrait", 8923748, 0], [1544, "the screaming man", 9237493, 0], [7416, "salvator mundi", 450000000, 0]]
